...
- the app still lacks a packaged installer or standalone public distribution format
...
3. cut the first public tag using `v0.1.0` and the new root `CHANGELOG.md`
4. run the new release checklist against the hosted repository state
5. watch the first outside parser and ESX issues closely to refine labels, templates, and contributor docs
